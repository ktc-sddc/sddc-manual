...
Nas Routing 은 Nas Shared Storage를 사용하기 위한 네트워크 연결 기능입니다. Nas Shared Storage가 생성 되면, 해당 Tenant에 Nas Routing은 자동으로 생성됩니다. 사용자 Subnet이 추가되면 자동으로 Nas Routing에 연결됩니다. Nas Routing이 생성되지 않거나, 연결 설정이 되지 않은 Subnet에서는 Nas Shared Storage를 사용할 수 없습니다.
...
SDDC 플랫폼 통해 생성된 모든 Nas Routing을 조회하는 기능입니다.
