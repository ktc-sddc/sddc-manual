...
4. 팝업 창이 닫히고, 방화벽 목록이 조회됩니다. 방화벽 연결을 삭제한 방화벽의 **\[방화벽 연결]** 버튼을 클릭합니다. 방화벽 연결 생성 화면으로 이동이 완료되면 삭제된 것을 확인할 수 있습니다.
...
> **Q. 방화벽에 Ping 관련 정책을 생성하려면 어떻게 해야 합니까?**
>
> A. Inner 방화벽과 Outer 방화벽에 따라 다르게 생성할 수 있습니다. Inner 방화벽은 ICMP 프로토콜 선택 후, Type을 8, Code를 0으로하는 정책을 하나 생성하면 정상 Ping 통신이 가능하고, Outer 방화벽은 출발지에서 도착지 사이에 ICMP 프로토콜 정책을 Type 8, Code 0인 정책과 출발지와 도착지를 바꾸어 Type 0, Code 0인 정책을 또 하나 생성하면 정상 Ping 통신이 가능합니다.
