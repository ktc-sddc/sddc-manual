...
Member Group 생성, 수정, 삭제, Health Monitor 관리, Member 관리 등을 제공하는 기능입니다.



#### Member Group 프로토콜 유형

Load Balancer 타입에 따라 Member Group에서 사용 가능한 프로토콜 타입이 제한 됩니다.

<table><thead><tr><th width="204.7768115942029">로드밸런서 유형</th><th width="265">Member Group 프로토콜 타입</th></tr></thead><tbody><tr><td><strong>NETWORK</strong></td><td></td></tr><tr><td><strong>APPLICATION</strong><br><strong>(출시 예정)</strong></td><td>HTTP, HTTPS</td></tr></tbody></table>
...
Member Group는 운영 상태, 배포 상태라는 두 가지 상태를 지니고 있습니다. 운영 상태는 현재 Member Group의 상태를 나타내고, 배포 상태는 Member Group 동작 제어에 따른 완료 상태를 의미합니다.
...
Member Group 목록 화면에서 특정 Member Group를 선택하면 상세 정보를 확인할 수 있습니다.

이 때 하위 메뉴 탭에서 **\[Health Monitor]**를 클릭하면 Member Group의 Health Monitor 정책을 확인할 수 있습니다.



이 때 하위 메뉴 탭에서 **\[Member]**를 클릭하면 Member Group에서 사용 중인 Member 목록을 확인할 수 있습니다.
